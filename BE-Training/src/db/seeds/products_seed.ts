import { MAX_IMAGE, MAX_PRICE, MAX_QUANTITY, MIN_IMAGE, MIN_PRICE, MIN_QUANTITY, PRODUCT_COLORS, PRODUCT_SIZES } from "@/constant/products_constant";
...
export function createRandomProducts(SHOPID: ObjectId, CategoryID: ObjectId): IProduct {
    return {
        _id: new ObjectId(),
